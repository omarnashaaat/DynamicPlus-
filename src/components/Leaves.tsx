...
export const Leaves = React.memo(({ employees, onUpdateEmployee }: LeavesProps) => {
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 no-print">
                ...
                <div className="relative">
                    ...
                    <input 
                        ...
                        className="bg-white border border-slate-100 rounded-2xl py-2 pr-10 pl-4 text-xs font-bold outline-none focus:ring-2 focus:ring-pink-500/20 transition-all w-48 md:w-64"
                        value={searchQuery}
