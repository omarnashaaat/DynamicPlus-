...
export const Contracts = React.memo(({ employees, contractRecords, setContractRecords }: ContractsProps) => {
    ...
    return (
        <div className="space-y-8 animate-fade-in">
                ...
                <div className="flex items-center gap-3">
                    <div className="relative">
                        ...
                        <input 
                            ...
                            className="bg-white border border-slate-100 rounded-2xl py-2 pr-10 pl-4 text-xs font-bold outline-none focus:ring-2 focus:ring-teal-500/20 transition-all w-48 md:w-64"
                            value={searchQuery}
                    ...
                    <button 
                        onClick={() => {
                            const element = document.querySelector('.contracts-container') as HTMLElement;
                            const opt = {
                                margin: 10,
                    ...
                    <button 
                        ...
                        className="bg-teal-600 text-white px-6 py-2.5 rounded-2xl font-black flex items-center gap-2 shadow-lg hover:bg-teal-700 transition-all no-print"
                    >
            ...
            <div className="rounded-[40px] shadow-2xl overflow-hidden border bg-white border-slate-100 contracts-container">
